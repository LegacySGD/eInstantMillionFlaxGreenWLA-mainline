...
public class MillionFlaxGreenWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MillionFlaxGreenWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MillionFlaxGreenWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MillionFlaxGreenWLAIW/InitOutcome.xml").getDocumentElement();
